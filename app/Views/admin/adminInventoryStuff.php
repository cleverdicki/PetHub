...
<div class="adminInventory_linkCategory">
    <a href="<?= base_url('/admin/inventory') ?>" class="adminInventory_category">Hewan</a>
    <a href="<?= base_url('/admin/inventory/stuff') ?>" class="adminInventory_category">Perlengkapan</a>
</div>
<div class="adminIventory_content">
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-3">
                    <a href="<?= base_url('/admin/inventory/addInventory') ?>" class="btn adminInventory_addInventoryButton">Tambah Inventory</a>
                </div>
                    ...
                    <div class="card adminInventory_card mx-auto" style="width: 20rem;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="adminInventory_card-button">
                                ...
                                <form action="/admin/inventoryStuff/<?= $data['id'] ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
