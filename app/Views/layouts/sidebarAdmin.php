<img src="<?= base_url('images/logoPawn.png') ?>" alt="logoPawn" width="50%" class="iconHeader">
<ul class="ul_sidebar_menu_admin">
    <div class="menu_item_div">
        <li class="menu_item"><a href="<?= base_url('/admin') ?>" class="link_menu_item"><img src="<?= base_url('images/HomeIcon.png') ?>" class="icon">Home</a></li>
    </div>
    <div class="menu_item_div">
